...
public class OneEightyUpload extends Source
{
  ...
  private class OpenTask extends Source.OpenTask
  {
    ...
    protected Boolean doInBackground(URL... params)
    {
      ...
      HttpPost post = CreatePostRequest(url,
                      new String[] { "op", op, "id", id, "fname", fname, "method_free", "Free download" });
      if (post == null)
      {
        ShowErrorDialog(Strings.ErrorParseFailure);
        return false;
      ...
      // Create the link
      String link = GetGroup("(?s)This download link.+?<a href=\"(.+?)\">",
                    page.toString());
  ...
  // Constructor
  public OneEightyUpload(OpenFragment fragment, TextView topText, ProgressBar progressBar,
