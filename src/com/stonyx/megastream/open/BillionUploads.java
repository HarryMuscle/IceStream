...
public class BillionUploads extends Source
{
  ...
  private class OpenTask extends Source.OpenTask
  {
    ...
    protected Boolean doInBackground(URL... params)
    {
      ...
      HttpPost post = CreatePostRequest(url,
                      new String[] { "op", op, "id", id, "rand", rand, "down_direct", "1" });
      if (post == null)
      {
        ShowErrorDialog(Strings.ErrorParseFailure);
        return false;
      ...
      // Create the link
      String link = GetGroup("<a href=\"(.+?)\">Download</a>", string);
  ...
  // Constructor
  public BillionUploads(OpenFragment fragment, TextView topText, ProgressBar progressBar,
