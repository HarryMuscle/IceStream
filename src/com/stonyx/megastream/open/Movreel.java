...
public class Movreel extends Source
{
  ...
  private class OpenTask extends Source.OpenTask
  {
    ...
    protected Boolean doInBackground(URL... params)
    {
      ...
      if (string.contains("You have reached the download-limit"))
      {
        ShowErrorDialog(Strings.ErrorLimitReached);
        return false;
      }
      ...
      // Send the post data
      post = CreatePostRequest(url, new String[] { "op", op, "id", id, "rand", rand,
      ...
      // Create the link
      String link = GetGroup("<a href=\"(.+?)\"><div class=\"t_download\"></div></a>\\s" +
                    "<div class=\"t_descont1\">", page.toString());
  ...
  // Constructor
  public Movreel(OpenFragment fragment, TextView topText, ProgressBar progressBar,
